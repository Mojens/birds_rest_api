...
app.get('/birds', (req, res) => {
    // at skrive ? er det samme som at sige req.query.type ? req.query.type.toLowerCase() : undefined;, det er så den ikke kaster en fejl ved at bruge toLowerCase på undefined
...
app.delete('/birds/:id', (req, res) => {
    ...
    // første argument er index, andet er antal
